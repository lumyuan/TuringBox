...
fun defaultTheme(
    ...
    if (!darkTheme)
        lightColorScheme(
            ...
            onPrimary = default_md_theme_light_onPrimary,
            primaryContainer = default_md_theme_light_primaryContainer,
            onPrimaryContainer = default_md_theme_light_onPrimaryContainer,
            secondary = default_md_theme_light_secondary,
            onSecondary = default_md_theme_light_onSecondary,
            secondaryContainer = default_md_theme_light_secondaryContainer,
            onSecondaryContainer = default_md_theme_light_onSecondaryContainer,
            tertiary = default_md_theme_light_tertiary,
            onTertiary = default_md_theme_light_onTertiary,
            tertiaryContainer = default_md_theme_light_tertiaryContainer,
            onTertiaryContainer = default_md_theme_light_onTertiaryContainer,
            error = default_md_theme_light_error,
            errorContainer = default_md_theme_light_errorContainer,
            onError = default_md_theme_light_onError,
            onErrorContainer = default_md_theme_light_onErrorContainer,
            background = default_md_theme_light_background,
            onBackground = default_md_theme_light_onBackground,
            outline = default_md_theme_light_outline,
            inverseOnSurface = default_md_theme_light_inverseOnSurface,
            inverseSurface = default_md_theme_light_inverseSurface,
            inversePrimary = default_md_theme_light_inversePrimary,
            surfaceTint = default_md_theme_light_surfaceTint,
            outlineVariant = default_md_theme_light_outlineVariant,
            scrim = default_md_theme_light_scrim,
            surface = default_md_theme_light_surface,
            onSurface = default_md_theme_light_onSurface,
            surfaceVariant = default_md_theme_light_surfaceVariant,
            onSurfaceVariant = default_md_theme_light_onSurfaceVariant,
        )
    else
        darkColorScheme(
            primary = default_md_theme_dark_primary,
            onPrimary = default_md_theme_dark_onPrimary,
            primaryContainer = default_md_theme_dark_primaryContainer,
            onPrimaryContainer = default_md_theme_dark_onPrimaryContainer,
            secondary = default_md_theme_dark_secondary,
            onSecondary = default_md_theme_dark_onSecondary,
            secondaryContainer = default_md_theme_dark_secondaryContainer,
            onSecondaryContainer = default_md_theme_dark_onSecondaryContainer,
            tertiary = default_md_theme_dark_tertiary,
            onTertiary = default_md_theme_dark_onTertiary,
            tertiaryContainer = default_md_theme_dark_tertiaryContainer,
            onTertiaryContainer = default_md_theme_dark_onTertiaryContainer,
            error = default_md_theme_dark_error,
            errorContainer = default_md_theme_dark_errorContainer,
            onError = default_md_theme_dark_onError,
            onErrorContainer = default_md_theme_dark_onErrorContainer,
            background = default_md_theme_dark_background,
            onBackground = default_md_theme_dark_onBackground,
            outline = default_md_theme_dark_outline,
            inverseOnSurface = default_md_theme_dark_inverseOnSurface,
            inverseSurface = default_md_theme_dark_inverseSurface,
            inversePrimary = default_md_theme_dark_inversePrimary,
            surfaceTint = default_md_theme_dark_surfaceTint,
            outlineVariant = default_md_theme_dark_outlineVariant,
            scrim = default_md_theme_dark_scrim,
            surface = default_md_theme_dark_surface,
            onSurface = default_md_theme_dark_onSurface,
            surfaceVariant = default_md_theme_dark_surfaceVariant,
            onSurfaceVariant = default_md_theme_dark_onSurfaceVariant,
        )
...
fun blueTheme(
    darkTheme: Boolean
): ColorScheme = defaultTheme(darkTheme)
