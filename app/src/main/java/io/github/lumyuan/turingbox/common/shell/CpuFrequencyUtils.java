...
import io.github.lumyuan.jni.NativeLib;
import io.github.lumyuan.turingbox.common.model.CpuClusterStatus;
import io.github.lumyuan.turingbox.common.model.CpuStatus;
...
public class CpuFrequencyUtils {
    ...
    private final NativeLib JNI = new NativeLib();
    ...
    public String getInputBoosterFreq() {
        return KernelProp.INSTANCE.getProp("/sys/module/cpu_boost/parameters/input_boost_freq");
    }
    ...
    public String getInputBoosterTime() {
        return KernelProp.INSTANCE.getProp("/sys/module/cpu_boost/parameters/input_boost_ms");
    }
    ...
    */
    ...
    public String getSechedBoostState() {
        return KernelProp.INSTANCE.getProp(sched_boost);
    }
