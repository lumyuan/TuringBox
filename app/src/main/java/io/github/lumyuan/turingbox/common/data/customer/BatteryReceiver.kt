...
import io.github.lumyuan.turingbox.common.calculator.GetUpTime
...
import io.github.lumyuan.turingbox.common.device.BatteryCapacity
import io.github.lumyuan.turingbox.common.shared.FileWrite
import io.github.lumyuan.turingbox.common.shell.BatteryUtils
import io.github.lumyuan.turingbox.common.shell.KeepShellAsync
import io.github.lumyuan.turingbox.common.shell.PropsUtils
import io.github.lumyuan.turingbox.common.store.SpfConfig
import java.util.*

class BatteryReceiver(private var service: Context, override val isAsync: Boolean = true) :
    IEventReceiver {
    ...
    private fun disableCharge() {
        Toast.makeText(TuringBox.application, R.string.charging_pause, Toast.LENGTH_SHORT).show()
        keepShellAsync?.doCmd(DisableCharge)
        chargeDisabled = true
    }

    private fun resumeCharge() {
        Toast.makeText(TuringBox.application, R.string.charging_resume, Toast.LENGTH_SHORT).show()
